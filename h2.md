...
Tämä on erittäin potentiaalinen ongelmakohta. Sillä yritin alla olevilla vaihtoehdoilla saada kyseistä t002:sta muodostumaan alisteiseksi. Ajoin jokaisen uuden master-muokkauksen jälkeen komennon: sudo systemctl restart salt-minion.service
